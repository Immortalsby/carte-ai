...
- **环境变量管理**：`DATABASE_URL`, `BETTER_AUTH_SECRET`, `GOOGLE_CLIENT_ID`, `GOOGLE_CLIENT_SECRET`, `KV_REST_API_URL`, `KV_REST_API_TOKEN`, `OPENAI_API_KEY`, `GEMINI_API_KEY`
...
**Then** 系统调用 Gemini Vision 进行 OCR 提取 + OpenAI 结构化
