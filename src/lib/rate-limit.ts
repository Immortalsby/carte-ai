...
// 菜品解释 API：30 次/分钟/IP（验证），15 次/分钟/IP（未验证）
export const explainRateLimit = createLimiter("ratelimit:explain", 30, "1 m");
export const explainRateLimitStrict = createLimiter("ratelimit:explain-strict", 15, "1 m");
