...
const dict = {
  ...
  hero_desc: {
    en: "A smart QR menu that recommends the right dishes based on budget, allergies and preferences \u2014 in 20 languages. Help every guest discover their perfect meal.",
    fr: "Un QR menu intelligent qui recommande les bons plats selon le budget, les allergies et les envies \u2014 en 20 langues. Aidez chaque convive a trouver son plat ideal.",
    zh: "一个智能 QR 菜单，根据预算、过敏原和口味偏好推荐合适的菜品——支持 20 种语言。帮每位顾客找到最满意的那道菜。",
  },
  hero_cta_primary: {
  ...
  social_1: { en: "20 languages supported", fr: "20 langues supportees", zh: "支持 20 种语言" },
  ...
  feat1_desc: {
    en: "PDF, menu photo, spreadsheet \u2014 our AI extracts dishes, translates into 20 languages, and detects allergens. You review and publish in 5 minutes.",
    fr: "PDF, photo de carte, tableur \u2014 notre IA extrait les plats, traduit en 20 langues, et detecte les allergenes. Vous verifiez et publiez en 5 minutes.",
    zh: "PDF、菜单照片、表格——AI 自动提取菜品，翻译成 20 种语言，检测过敏原。5 分钟内审核发布。",
  },
  ...
  feat1_b4: { en: "Auto-translation FR/EN/ZH + 17 languages", fr: "Traduction automatique FR/EN/ZH + 17 langues", zh: "自动翻译法/英/中 + 17 种语言" },

  feat2_tag: { en: "Multilingual menu", fr: "Menu multilingue", zh: "多语言菜单" },
  feat2_title: {
    en: "One menu, 20 languages, instant translation.",
    fr: "Un menu, 20 langues, traduction instantanee.",
    zh: "一份菜单，20 种语言，即时翻译。",
  },
  feat2_desc: {
  ...
  feat2_b1: { en: "20 languages auto-detected from phone settings", fr: "20 langues detectees automatiquement depuis le telephone", zh: "根据手机语言自动切换 20 种语言" },
  ...
  comp_col_langs: { en: "20 langs", fr: "20 langues", zh: "20 语言" },
  ...
  price_starter: { en: "À La Carte", fr: "À La Carte", zh: "单点" },
  ...
  price_starter_f4: { en: "20 languages", fr: "20 langues", zh: "20 种语言" },
  ...
  price_pro: { en: "Prix Fixe", fr: "Prix Fixe", zh: "套餐" },
  ...
  price_pro_f1: { en: "Everything in À La Carte +", fr: "Tout À La Carte +", zh: "包含单点所有功能 +" },
  ...
  price_enterprise: { en: "Sur Mesure", fr: "Sur Mesure", zh: "定制" },
  price_enterprise_desc: { en: "Multi-site, white label, API.", fr: "Multi-sites, marque blanche, API.", zh: "多门店、白标、API。" },
  price_enterprise_custom: { en: "Custom", fr: "Sur devis", zh: "定制报价" },
  price_enterprise_f1: { en: "Everything in Prix Fixe +", fr: "Tout Prix Fixe +", zh: "包含套餐所有功能 +" },
  ...
  faq6_a: {
    en: "20 languages including French, English, Chinese (Simplified & Traditional), Arabic, Japanese, Korean, Spanish, Portuguese, Hindi, and more. Language is auto-detected from the customer\u2019s phone.",
    fr: "20 langues dont le francais, l\u2019anglais, le chinois (simplifie et traditionnel), l\u2019arabe, le japonais, le coreen, l\u2019espagnol, le portugais, l\u2019hindi, et bien d\u2019autres. La langue est detectee automatiquement a partir du telephone du client.",
    zh: "支持 20 种语言，包括法语、英语、中文（简体和繁体）、阿拉伯语、日语、韩语、西班牙语、葡萄牙语、印地语等。语言从顾客手机自动检测。",
  },
  ...
  faq8_a: {
    en: "Absolutely. No commitment, no cancellation fees. You can also stay on the À La Carte plan as long as you want.",
    fr: "Absolument. Pas d\u2019engagement, pas de frais de r\u00e9siliation. Vous pouvez aussi rester sur le plan \u00c0 La Carte aussi longtemps que vous voulez.",
    zh: "当然可以。无承诺，无取消费。你也可以一直使用单点版。",
  },
